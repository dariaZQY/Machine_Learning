...
####1.22.2####
library(readr)
prgeng <- read_csv("~/Desktop/MSBA Winter/BAX 452 Machine Learning/Session 4/MLDatasets/prgeng.csv")
...
```{r}
####2.14.2####
day <- read_csv("~/Desktop/MSBA Winter/BAX 452 Machine Learning/Session 4/MLDatasets/Bike-Sharing-Dataset/day.csv")
...
# ??2=1-Var(E)/Var(Y)=1-Var(E)/Var(mean(x)+Var(E)=1-rho/2*rho=0.5
```